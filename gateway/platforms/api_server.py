...
class APIServerAdapter(BasePlatformAdapter):
    ...
    async def _handle_session_chat(self, request: "web.Request") -> "web.Response":
        ...
        # Reihenfolge: erst Upstream-Media-Aufloesung (data-URLs), DANN Action-Intent-Extraktion.
        # Die <<<JARVIS_ACTION_INTENT>>>-Marker koennen NICHT mit base64-data-URLs kollidieren
        # (base64-Alphabet enthaelt kein '<'/'>'), daher ist die Marker-Trennung weiterhin sauber.
        tts_text, action_intent = extract_action_intent(final_response)
        headers = {"X-Hermes-Session-Id": effective_session_id or session_id}
